...
export default function ProfilePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      updateUser({ fullName: accountForm.fullName, picture: pictureUrl });
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <h2 className="text-2xl font-bold tracking-tight">
        {isSuperadmin ? "Profile Settings" : "My Profile"}
      </h2>
      ...
      <div className="card bg-base-100 border border-base-content/10 shadow-sm p-6">
        <div className="flex flex-col sm:flex-row items-center gap-6">
          <div
            className="relative avatar cursor-pointer group"
            ...
            <div className="space-y-4">
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-medium">
                    <Phone className="w-4 h-4 inline mr-2 text-base-content/50" />
                    Phone
                  </span>
                </label>
                <input
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="form-control">
                  <label className="label">
                    <span className="label-text font-medium">
                      <Link className="w-4 h-4 inline mr-2 text-base-content/50" />
                      LinkedIn
                    </span>
                  </label>
                  <input
                ...
                <div className="form-control">
                  <label className="label">
                    <span className="label-text font-medium">
                      <Globe className="w-4 h-4 inline mr-2 text-base-content/50" />
                      Portfolio URL
                    </span>
                  </label>
                  <input
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-medium">
                    <FileText className="w-4 h-4 inline mr-2 text-base-content/50" />
                    Professional Summary
                  </span>
                </label>
                <textarea
                  value={publicProfile.professionalSummary || ""}
                  onChange={(e) =>
                    setPublicProfile({
                      ...publicProfile,
